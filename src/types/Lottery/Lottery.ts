...
export class Lottery__viewLotteryResultValue0Struct extends ethereum.Tuple {
  ...
  get cakePerBracket(): Array<BigInt> {
  ...
  get amountCollectedInCake(): BigInt {
...
export class Lottery extends ethereum.SmartContract {
  ...
  maxPriceTicketInCake(): BigInt {
    let result = super.call(
      "maxPriceTicketInCake",
      "maxPriceTicketInCake():(uint256)",
      []
    );
  ...
  try_maxPriceTicketInCake(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxPriceTicketInCake",
      "maxPriceTicketInCake():(uint256)",
      []
  ...
  minPriceTicketInCake(): BigInt {
    let result = super.call(
      "minPriceTicketInCake",
      "minPriceTicketInCake():(uint256)",
      []
    );
  ...
  try_minPriceTicketInCake(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "minPriceTicketInCake",
      "minPriceTicketInCake():(uint256)",
      []
...
export class SetMinAndMaxTicketPriceInCakeCall extends ethereum.Call {
  get inputs(): SetMinAndMaxTicketPriceInCakeCall__Inputs {
    return new SetMinAndMaxTicketPriceInCakeCall__Inputs(this);
  }

  get outputs(): SetMinAndMaxTicketPriceInCakeCall__Outputs {
    return new SetMinAndMaxTicketPriceInCakeCall__Outputs(this);
  }
}

export class SetMinAndMaxTicketPriceInCakeCall__Inputs {
  _call: SetMinAndMaxTicketPriceInCakeCall;

  constructor(call: SetMinAndMaxTicketPriceInCakeCall) {
    this._call = call;
  }

  get _minPriceTicketInCake(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _maxPriceTicketInCake(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class SetMinAndMaxTicketPriceInCakeCall__Outputs {
  _call: SetMinAndMaxTicketPriceInCakeCall;
